  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("FileType", {
      ...
      callback = function()
        ...
        -- Navigation
        vim.keymap.set("n", "[r", "<cmd>lua require('kulala').jump_prev()<cr>",
          vim.tbl_extend("force", opts, { desc = "Jump to previous request" }))
        vim.keymap.set("n", "]r", "<cmd>lua require('kulala').jump_next()<cr>",
        ...
        vim.keymap.set("n", "<leader>ri", "<cmd>lua require('kulala').inspect()<cr>",
