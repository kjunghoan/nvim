-- lsp/jdtls.lua (place in your runtime path)
return {
  cmd = function()
    -- Get the current OS
    ...
    if launcher_jar == "" then
      vim.notify("Failed to find JDTLS launcher jar. Please check your installation.", vim.log.levels.ERROR)
      return nil
    end
  ...
  settings = {
    java = {
      ...
      format = {
        enabled = true,
        settings = {
          url = vim.fn.stdpath("data") .. "/mason/packages/jdtls/formatter.xml",
        },
      },
  ...
  -- Custom attach function to add specific key mappings
  on_attach = function(client, bufnr)
    -- Register keybindings for Java-specific functionality
